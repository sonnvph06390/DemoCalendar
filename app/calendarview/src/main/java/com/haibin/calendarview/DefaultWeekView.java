...
/**
 *Mặc định tuần xem Meizu giả cao
...
public final class DefaultWeekView extends WeekView {
    ...
    /**
     * 如果需要点击Scheme没有效果，则return true Nếu bạn cần bấm Scheme, không có hiệu lực, thì trả về true
     *
     * @param canvas    canvas
     * @param calendar  日历日历calendar
     * @param x         日历Card x起点坐标
     * @param hasScheme hasScheme 非标记的日期 Ngày không đánh dấu
     * @return true 则绘制onDrawScheme Sau đó vẽ trênDrawScheme，因为这里背景色不是是互斥的 Bởi vì màu nền không loại trừ lẫn nhau
     */
    @Override
    ...
    /**
     * 获取字体的宽 Lấy chiều rộng của phông chữ
     * @param text text
     * @return return
     */
