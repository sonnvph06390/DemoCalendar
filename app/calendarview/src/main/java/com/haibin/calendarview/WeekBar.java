...
/**
 * Thanh tuần, nếu bạn muốn sử dụng tùy chỉnh thanh tuần, hãy nhớ sử dụng hợp nhất với XML, không sử dụng linearLayout
...
public class WeekBar extends LinearLayout {
    ...
    /**
     * Đặt màu văn bản, sử dụng bố cục tùy chỉnh cần ghi đè phương thức này để tránh sự cố
     *       * Nếu lỗi được báo cáo ở đây, vui lòng đảm bảo rằng tệp và bố cục XML tùy chỉnh của bạn đang sử dụng hợp nhất thay vì linearLayout.
     *
     * @param color color
     */
