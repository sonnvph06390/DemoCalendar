...
/**
 * Bố cục lịch
 *   * Mỗi lớp sử dụng quyền gói để tránh công khai không cần thiết
 */
...
public class CalendarView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        mDelegate.mInnerListener = new OnInnerDateSelectedListener() {
             ...
             * @param isClick  Có phải là một nhấp chuột?
             */
            @Override
    ...
    /**
     * Chọn xem chế độ xem mở trong năm của tháng
     *
    ...
    /**
     *  Đóng chế độ xem năm và tháng để chọn bố cục
     */
    ...
    /**
     * Đóng bố cục lịch và cuộn đến vị trí đã chỉ định
     *
     * @param position 某一年
     */
    ...
    /**
     * Di chuyển đến ngày đã chỉ định
     *
     * @param year  year
     * @param month month
     * @param day   day
     ...
     * @param day            day
     * @param smoothScroll   smoothScroll
     * @param invokeListener Cuộc gọi ngày sự kiện
     */
    ...
    /**
     * Di chuyển đến một năm nhất định
     *
     * @param year 快速滚动的年份
     */
    ...
    /**
     * Đặt xem chế độ xem tháng có thể cuộn được không
     *
    ...
    /**
     *Đặt xem chế độ xem theo tuần có thể cuộn được không
     *
    ...
    /**
     * Đặt xem chế độ xem năm có thể cuộn được không
     *
    ...
    /**
     * Đặt chiều cao của mục xem tháng
     *
    ...
    /**
     * Đặt chế độ hiển thị thành tất cả
     */
    ...
    /**
     * Đặt chế độ hiển thị thành chỉ tháng hiện tại
     */
     ...
     *
     * @param mode Chế độ hiển thị xem tháng
     */
    ...
    /**
     * Cập nhật giao diện,
     *       * Bạn cần gọi phương thức này để đặt lại màu, v.v.
     */
