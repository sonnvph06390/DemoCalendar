...
/**
 * Chế độ xem lịch cơ bản, xuất phát từ MonthView và WeekView
...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
    ...
    /**
     * Màu văn bản tháng  âm lịch được chọn
     */
    protected Paint mSelectedLunarTextPaint = new Paint();

    /**
     * Màu văn bản tháng âm lịch khác
     */
    ...
    /**
     * Đánh dấu màu văn bản ngày âm lịch hiện tại
     */
    protected Paint mCurDayLunarTextPaint = new Paint();

    /**
     * Bố cục lịch, bạn cần đặt bố cục của riêng bạn bên dưới lịch
     */
    ...
    /**
     * Khởi tạo tất cả các cấu hình UI
     *
